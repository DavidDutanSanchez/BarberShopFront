    ...
    <div className="bg-white text-black font-sans w-full overflow-x-hidden">
      ...
      <section ref={seccionComentarios} className="py-20 px-4 sm:px-6 bg-white border-t-2 border-gray-200">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
          ...
          {/* FORMULARIO */}
          <div className="bg-white rounded-3xl shadow-xl p-8 sm:p-10 hover:shadow-2xl transition-all border border-gray-100">
            <h2 className="text-4xl sm:text-5xl font-extrabold text-center text-[#FFD700] mb-4 drop-shadow-lg">
              ¿Tienes algo que decirnos?
            </h2>
            <p className="text-center text-gray-600 text-lg mb-10">
              En <strong>Pintado Barber Shop</strong> valoramos tu opinión. Déjanos tus comentarios, sugerencias o felicitaciones.
            </p>

            <form className="grid gap-6" onSubmit={sendEmail} ref={form}>
              <input
                type="text"
                name="nombre"
                placeholder="Nombres y Apellidos"
                className="p-4 border border-gray-300 rounded-lg shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#FFD700] transition"
                required
              />
              <input
                type="email"
              ...
              <textarea
                ...
                rows={5}
                className="p-4 border border-gray-300 rounded-lg shadow-sm hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#FFD700] transition resize-none"
                required
              />
              <button
                type="submit"
                className="bg-[#FFD700] hover:bg-yellow-400 text-black font-bold text-lg py-3 px-6 rounded-lg transition duration-300 shadow-md hover:shadow-xl"
              >
                Enviar Comentario ✉️
              </button>
            </form>
          ...
          {/* INFORMACIÓN Y MAPA CON MAPA ARRIBA */}
          <div className="bg-black text-[#FFD700] p-8 sm:p-12 rounded-2xl shadow-2xl transition-all hover:scale-[1.01] duration-300">

            {/* MAPA AMPLIO */}
            <div className="w-full h-[450px] rounded-xl overflow-hidden shadow-xl border-2 border-[#FFD700] mb-8">
              <iframe
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              <div className="bg-white p-4 rounded-full shadow-md">
                <img src="/assets/rekoj.png" alt="Horario" className="w-24 h-24 sm:w-28 sm:h-28" />
              </div>
              <h3 className="text-3xl sm:text-4xl font-extrabold">ATENCIÓN TODOS LOS DÍAS</h3>
              <p className="text-xl sm:text-2xl tracking-wider">09H00 a 20H00</p>
              <a
                href="https://www.google.com/maps?q=PINTADO+BARBER+SHOP"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-4 bg-[#FFD700] hover:bg-yellow-400 text-black font-bold py-2 px-6 rounded-lg shadow-md transition duration-300"
              >
                Cómo llegar
              </a>
            </div>
